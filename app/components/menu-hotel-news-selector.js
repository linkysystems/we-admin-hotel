...
export default Ember.Component.extend({
  ...
  didInsertElement() {
    return this.get('store').query('hotel-news', {
      limit: 8,
  ...
  actions: {
    ...
    listaChecked() {
      ...
      // toggle page selection:
      if (pagesSelected['hotel-news_list']) {
        delete pagesSelected['hotel-news_list'];
      } else {
        pagesSelected['hotel-news_list'] = {
          isList: true,
          linkPermanent: '/hotel-news'
        };
      }
